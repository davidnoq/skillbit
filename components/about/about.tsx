...
const About = () => {
  ...
  return (
    <div className="text-white text-center bg-gradient-to-b from-transparent to-indigo-900 flex items-center">
      <div className="relative max-w-screen-3xl my-20 mx-auto">
        <h1 ref={ref} className="text-5xl mt-10">
          <div
            style={{
        ...
        <div className="flex flex-col lg:flex-row items-center gap-40">
          <div className=" border-2 border-white/[.10] rounded-3xl relative h-[400px] w-[450px] mt-20 group">
            ...
            <div className="text-left absolute inset-x-4 bottom-5">
              Generate code with topic specific questions. Take a step further
