        ...
        <div className="w-full max-w-6xl mx-auto py-20 px-6 flex gap-x-10">
          <div className="w-1/4 hidden md:block">
            <ul className="w-60 shrink-0 sticky top-8 flex flex-col text-sm gap-y-2">
              ...
              <li>
                <a href="#accessing-skillbit" className="text-slate-300 no-underline">Accessing Skillbit</a>
              </li>
              <li>
                <a href="#completing-your-assessment" className="text-slate-300 no-underline">Completing your Assessment</a>
              </li>
            </ul>
          </div>
          ...
          <div className="w-3/4">
            ...
            <p className="mt-8">
              After submitting your application, you will receive an email with a link to the Skillbit platform. Click on the link to get started.
            </p>
            <h1 className="text-xl font-bold mt-10">Check the following:</h1>
            <ul className="list-disc list-inside mt-4">
              <li>Ensure you're logged into the email account used for your application.</li>
              <li>Check your spam or junk folder for missed messages.</li>
              <li>Verify that your internet connection is stable.</li>
            </ul>
            <p className="mt-8">
              You'll receive an email from <span className="font-bold text-indigo-300">skillbitassessment@gmail.com</span>, which will include a link to the Skillbit platform. From there, you can 
            ...
            <p className="mt-8">
              Once you click 'Get Started,' you'll be directed to the assessment pre-screen. Once you're ready to begin, you can click 'Start Test' located at the bottom of the page.
            </p>
            <Image
            ...
            <h1 id="completing-your-assessment"className="text-4xl font-bold mt-10">Completing Your Assessment</h1>
            <p className="mt-8">
              You will be redirected to your designated test. Here, you will have access to a code editor, a question prompt, and a timer. After you've completed the assessment,
              click 'Submit' in the bottom left-hand corner. Here's an example of what to expect:
            </p>
            <Image
            ...
            <p className="mt-8">
              After clicking 'Submit', you have finalized your submission. And that's it! You've completed the Skillbit assessment.
            </p>
